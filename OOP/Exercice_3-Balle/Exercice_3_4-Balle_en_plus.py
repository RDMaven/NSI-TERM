...
class ZoneDeJeu(Canvas) :
    ...
    def creerBalle(self, size=16, couleur="red"):
        self.balle = Balle(self, size, couleur, randrange(20,360,30), 5) #zone, diamètre, couleur, vitesse
    ...
    def autreBalle(self, event):
        ...
        #print(x, y)
        self.balle2 = Balle(self, randrange(16,30,4), couleur, randrange(20,360,30), 5, tag='autre') #zone, diamètre, couleur, vitesse
